...
question Question answer:  "Multiline comments are made by having the three quotation marks on each side of the comment."
...
Print(Variables are usefull in codeing becuase they can represent numeric values, characters, character strings, or memory 
addresses. They also give flexability to the coder or programmer. Instead of entering the data directly into the code,
a coder can use a variable to represent the data.)
